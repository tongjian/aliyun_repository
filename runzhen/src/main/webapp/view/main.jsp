...
<title>首页</title>
<link rel="icon" href="<%=contextPath%>/image/favicon.ico">
<link href="<%=contextPath%>/js/bootstrap-3.3.7-dist/css/bootstrap.min.css" rel="stylesheet">
<link href="<%=contextPath%>/js/bootstrapvalidator-0.4.5/dist/css/bootstrapValidator.min.css" rel="stylesheet">
<link href="<%=contextPath%>/js/bootstrap3-dialog-master/dist/css/bootstrap-dialog.min.css" rel="stylesheet">
				...
				<div class="container-fluid"> 
				    ...
				    <div>
				        ...
				        <ul class="nav navbar-nav navbar-right">
				    		<li>
				    			<a id="manage_a" href="#" onclick="manage_click()"><strong>控制台</strong></a>
				    		</li>
				    	</ul>
				    </div>
				</div>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
        	<img src="<%=contextPath%>/image/slide-01.jpg" alt="">
          <div class="container">
        ...
        <div class="item">
        	<img src="<%=contextPath%>/image/slide-02.jpg" alt="">
          <div class="container">
            <div class="carousel-caption">
        ...
        <div class="item">
        	<img src="<%=contextPath%>/image/slide-03.jpg" alt="">
          <div class="container">
            <div class="carousel-caption">
             ...
             <div class="modal-content">
                 ...
                 <div class="modal-body">
                     <form id="register_form" role="form" class="form-group" action="">
                             ...
                             <a href="" data-toggle="modal" data-dismiss="modal" data-target="#login_modal">已有账号？点我登录</a>
                     </form>
                 </div>
             </div>
         </div>
...
<script src="<%=contextPath%>/js/bootstrap-validator-master/dist/validator.js"></script>
...
function manage_click(){
	...
	if(userCode != '' && userCode != undefined){
		location.href = '<%=contextPath%>/common/forward?page=manage';
	}else{
